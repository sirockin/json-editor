...
Scenario('should work with button editor with option validated = true @failing_button', async (I) => {
  I.amOnPage('button-callbacks.html');
  ...
  I.click('[data-schemapath="root.button1"] button'); // Added on advice of @pm65
